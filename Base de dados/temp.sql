...
--CONECTAR OS INGREDIENTES ID Á TABELA INGREDIENTE
ALTER TABLE receita
ADD CONSTRAINT fk_utilizador_id FOREIGN KEY(utilizador_id) REFERENCES utilizador (user_id);
